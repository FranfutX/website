  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-16">
      ...
      <motion.div
        ...
        <Icon size={40}className="text-gray-300 transition-colors duration-200 group-hover:text-orange-400"/>
        <p className="text-sm text-gray-300 transition-colors duration-200 group-hover:text-orange-400">
          {name}</p>
      </motion.div>))}
      </div>
    </section>);}